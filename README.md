 ...
 * `-aj` or `--drop-denser`: When dropping dots at zoom levels below the base zoom, give a 50% preference to retaining
   points in sparse areas and dropping points in dense areas.
